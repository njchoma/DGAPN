...
def load_conditional(filepath):
    ...
    with open(filepath, 'r') as fp:
        ...
        data = data[0:800]
    return data
# test_ = load_conditional("/Users/ADChen/Downloads/MD/2col/NSP15_6W01_A_1_F.Orderable_zinc_db_enaHLL.2col.csv")
# print(random.sample(test_, 1)[0])
# print("Done")
...
class MoleculeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if terminate_condition or self.force_final:
            ...
            # Generator can terminate even though the resulting chemical is not valid?
    ...
    def get_final_smiles(self):
        ...
        smile = Chem.MolToSmiles(m, isomericSmiles=True)
        if smile is None:
            return "Invalid"
        else:
            return smile
