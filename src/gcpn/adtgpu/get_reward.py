...
def get_dock_score(smiles):
    ...
    receptor_file="/global/home/users/nchoma/repos/exaLearnMol/src/gcpn/adtgpu/receptor/NSP15_6W01_A_3_H_receptor.pdbqt"
    smiles = str(smiles)
    run_dir="/global/home/users/nchoma/repos/exaLearnMol/src/gcpn/adtgpu/autodockgpu"
    #Executable paths
    # For Summit systems
