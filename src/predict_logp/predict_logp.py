...
def main(artifact_path,
         logp,
         smiles,
         task_name='predict_logp',
         batch_size=512,
         num_workers=24,
         nb_hidden=512,
         nb_layer=7,
         lr=0.001):
    artifact_path = os.path.join(artifact_path, task_name)
    ...
    # print(len(train_data), len(valid_data), len(test_data)) # Think about data augmentation.
